...
describe('RateLimitedCard', () => {
  it('should render the rate-limit heading', () => {
    ...
    expect(
      screen.getByText(/You've used your free blueprint for this 30-day window\./i)
    ).toBeInTheDocument();
  });
  ...
  it('should render the provided message', () => {
    ...
    expect(
      screen.getByText('Your next blueprint unlocks on June 15.')
    ).toBeInTheDocument();
  });
  ...
  it('should explain the Opus 4.6 free-tier rationale', () => {
    render(<RateLimitedCard message="Try again later." />);
    expect(
      screen.getByText(/Opus 4\.6 is expensive to run at scale/i)
    ).toBeInTheDocument();
  });
  ...
  it('should render the embedded Pro waitlist with custom heading and subheading', () => {
    ...
    expect(
      screen.getByText(/Join the Pro waitlist for higher limits/i)
    ).toBeInTheDocument();
  });
