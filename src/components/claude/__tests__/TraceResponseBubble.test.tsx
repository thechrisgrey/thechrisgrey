...
describe('TraceResponseBubble', () => {
  it('renders the response content', () => {
    render(
      <TraceResponseBubble content="Hello there" isStreaming={false} isSystemMessage={false} />
    );
  ...
  it('suppresses live announcements while streaming (aria-live="off")', () => {
    const { container } = render(
      <TraceResponseBubble content="partial" isStreaming isSystemMessage={false} />
    );
  ...
  it('shows the off-topic badge for system messages', () => {
    render(
      <TraceResponseBubble content="off topic" isStreaming={false} isSystemMessage />
    );
