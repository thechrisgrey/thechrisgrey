...
export const Button = ({
  ...
  const baseClasses = 'inline-flex items-center justify-center font-medium transition-all duration-200 active:scale-[0.98] focus:outline-hidden focus:ring-2 focus:ring-altivum-gold focus:ring-offset-2 focus:ring-offset-altivum-dark disabled:opacity-50 disabled:cursor-not-allowed';
