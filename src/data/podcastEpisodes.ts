...
const FALLBACK_EPISODES: PodcastEpisode[] = [
  {
    ...
    description:
      'A conversation exploring the intersection of technical expertise, leadership, and the evolving role of artificial intelligence in modern cloud engineering. Daniel discusses his journey from a non-technical background to earning the AWS Golden Jacket certification, sharing insights on non-traditional career pathways, the value of certifications, and the importance of lifelong learning.',
...
export const PODCAST_EPISODES: PodcastEpisode[] =
  generatedData.episodes.length > 0 ? (generatedData.episodes as PodcastEpisode[]) : FALLBACK_EPISODES;
